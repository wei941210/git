...
public class AdreplaceCtrl {
    ...
    @Autowired
    private IAdreplaceService adreplaceService;
...
/*-----------------------------------------------------------------------------------------------------------文件操作-----------------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public ResponseEntity<ResponseModel> dispatch(String targetUrl,@RequestParam(value = "isAsync",required = false,defaultValue = "false")Boolean isAsync,@RequestParam("fileName") String fileName){
        if (isAsync){
